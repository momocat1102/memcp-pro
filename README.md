...
- [memory-lancedb-pro](https://github.com/CortexReach/memory-lancedb-pro) by CortexReach — Our earlier TypeScript memory system (LanceDB + Jina Embeddings) whose cognitive-science design patterns (Weibull decay, seven dedup decisions, L0/L1/L2 layered storage) were ported to memcp's Python/SQLite architecture.
